const items = [
  ...
  Priority = {
      NULL: "0 az 1 zakupeny produkt",
      FIVE: "2 az 3 zakupeny produkt",
      TEN:"4 a viac zakupeny produkt"
  }
...
//    console.log(items.length)
  ...
  console.log("Status a priorita",users.map(mapUsers))
  console.log("dospely s velkou prioritou", users.map(mapUsers).filter(isAdult))
